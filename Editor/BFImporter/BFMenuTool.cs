...
namespace PFrame.BFImporter.Editor
{

    public class BFMenuTool
    {
        [MenuItem("PFrame/Bitmap Font/Rebuild Bitmap Font", true)]
        ...
        [MenuItem("PFrame/Bitmap Font/Rebuild Bitmap Font")]
        ...
        [MenuItem("PFrame/Bitmap Font/Rebuild All Bitmap Font", true)]
        public static bool CheckRebuildAllFont()
        {
            return !EditorApplication.isPlaying;
        }

        [MenuItem("PFrame/Bitmap Font/Rebuild All Bitmap Font")]
